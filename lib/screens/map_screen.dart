...
//   final int humidity;
//   final String city;
//   const MapScreen({required this.lat, required this.lon, required this.temp, required this.humidity, required this.city, super.key});
//
//   @override
...
//     final initial = CameraPosition(target: LatLng(widget.lat, widget.lon), zoom: 8);
//     final marker = Marker(
//       markerId: const MarkerId('sel'),
//       position: LatLng(widget.lat, widget.lon),
//       infoWindow: InfoWindow(
//         title: widget.city,
//         snippet: 'Temp: ${widget.temp.toStringAsFixed(1)}°C • Humidity: ${widget.humidity}%',
//       ),
//     );
//
//     return Scaffold(
...
//       return Tile(256, 256, response.bodyBytes); // width, height, bytes
//     } else {
//       return Tile(256, 256, Uint8List(0)); // empty tile
//     }
//   }
// }
